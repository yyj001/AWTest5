...
public class PcDeleteActivity extends WearableActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pc_delete);
        // Enables Always-on
        setAmbientEnabled();
        initData();
    }
    ...
    private void initData() {
        ...
        //recyclerView init
        mRecyclerView = (WearableRecyclerView) findViewById(R.id.pc_delete_recycler_view);
        ...
        myAdapter.setOnItemLongClickListener(new MyAdapter.OnItemLongClickListener() {
            ...
            public void onItemLongClick(int position,String name) {
                ...
                AcceptDenyDialog dialog = new AcceptDenyDialog(PcDeleteActivity.this);
                ...
                dialog.setPositiveButton(new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        DataSupport.deleteAll(PinCodeKnockData.class, "userName = ?", myName);
                        //移出动画
                        settingItemList.remove(pos);
                        myAdapter.notifyItemRemoved(pos);
                        myAdapter.notifyItemRangeChanged(0,settingItemList.size()-pos);

                        Intent intent = new Intent(PcDeleteActivity.this, ConfirmationActivity.class);
