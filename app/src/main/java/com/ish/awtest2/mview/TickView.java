...
public class TickView extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.TickView);
        mConfig.setUnCheckBaseColor(typedArray.getColor(R.styleable.TickView_uncheck_base_color, getResources().getColor(R.color.white)))
                .setCheckBaseColor(typedArray.getColor(R.styleable.TickView_check_base_color, getResources().getColor(R.color.blue)))
        ...
        com.ish.awtest2.mview.TickRateEnum mTickRateEnum = com.ish.awtest2.mview.TickRateEnum.getRateEnum(rateMode);
        ...
        mFinalAnimatorSet.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mConfig.getTickAnimatorListener() != null) {
                    mConfig.getTickAnimatorListener().onAnimationEnd(com.ish.awtest2.mview.TickView.this);
                }
            }
            ...
            public void onAnimationStart(Animator animation) {
                super.onAnimationStart(animation);
                if (mConfig.getTickAnimatorListener() != null) {
                    mConfig.getTickAnimatorListener().onAnimationStart(com.ish.awtest2.mview.TickView.this);
                }
            }
        });
    }
            ...
            public void onClick(View view) {
                if (mConfig.isClickable()) {
                    ...
                    if (mConfig.getOnCheckedChangeListener() != null) {
                        mConfig.getOnCheckedChangeListener().onCheckedChanged((com.ish.awtest2.mview.TickView) view, isChecked);
                    }
                }
            }
        });
...
//        mTickPath.reset();
//        if (type == TYPE_ERROR) {
//            final float x1 = centerX - tickRadius;
//            final float y1 = centerY - tickRadius;
//
//            final float x2 = centerX + tickRadius;
//            final float y2 = centerY + tickRadius;
//
//            final float x3 = centerX + tickRadius;
//            final float y3 = centerY - tickRadius;
//
//            final float x4 = centerX - tickRadius;
//            final float y4 = centerY + tickRadius;
//            mTickPath.moveTo(x1, y1);
//            mTickPath.lineTo(x2, y2);
//            mTickPath.moveTo(x3, y3);
//            mTickPath.lineTo(x4, y4);
//        } else {
...
//        }
    ...
    protected void onDraw(Canvas canvas) {
        float tickRadius = mConfig.getTickRadius();
        float tickRadiusOffset = mConfig.getTickRadiusOffset();
    ...
    public void setType(int type) {
        this.type = type;
        if (type == TYPE_ERROR) {
            mConfig.setCheckBaseColor( getResources().getColor(R.color.red));
        }else{
                mConfig.setCheckBaseColor(getResources().getColor(R.color.green));
